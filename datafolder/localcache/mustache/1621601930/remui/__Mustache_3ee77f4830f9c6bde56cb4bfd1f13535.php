...
class __Mustache_3ee77f4830f9c6bde56cb4bfd1f13535 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockC2ee9bd82f3b8cb85e852b9e6985d9df'),
            ));
...
';
    ...
    public function blockC2ee9bd82f3b8cb85e852b9e6985d9df($context)
    {
        $indent = $buffer = '';
