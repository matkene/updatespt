...
class __Mustache_4e6c7ea720e2aa5194f9b593bb89cc4a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="hidden border-bottom p-5 view-search" ';
...
';
        ...
        $buffer .= $indent . '        </a>
';
        $buffer .= $indent . '        <div class="input-group input-search input-search-dark">
';
        $buffer .= $indent . '            <input
';
        $buffer .= $indent . '                type="text"
';
        $buffer .= $indent . '                class="form-control" style="border-color: #e4eaec!important;"
';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '		    style="border-radius: 0 200px 200px 0; background: #f3f7f9;"
';
        $buffer .= $indent . '                >
';
