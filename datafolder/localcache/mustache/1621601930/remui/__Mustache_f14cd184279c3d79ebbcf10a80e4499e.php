...
class __Mustache_f14cd184279c3d79ebbcf10a80e4499e extends Mustache_Template
{
...
';
        $buffer .= $indent . '<div
';
        $buffer .= $indent . '    class="section card mb-0"
';
...
';
        ...
        $buffer .= '-toggle" class="card-header px-0 py-10 bg-transparent" data-region="toggle">
';
        $buffer .= $indent . '        <span
';
        $buffer .= $indent . '            class="w-100 overview-section-toggle ';
...
';
        ...
        $buffer .= $indent . '            </span>
';
        $buffer .= $indent . '            <span class="font-size-10 ';
        ...
        $buffer .= ' badge badge-pill badge-important mt-1 float-right"
';
