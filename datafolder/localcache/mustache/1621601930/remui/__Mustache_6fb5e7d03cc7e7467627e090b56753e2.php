...
class __Mustache_6fb5e7d03cc7e7467627e090b56753e2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('theme_remui/remui_popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'blockDaa0220d66d3f3ef20967ffadba14508'),
                ...
                'headeractions' => array($this, 'block31aa3c1866a7493ddfafecc9d79abbe8'),
                'footeractions' => array($this, 'block67999e2f21333f5157f00bef03d98aea'),
...
';
    ...
    public function blockDaa0220d66d3f3ef20967ffadba14508($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <i class="icon fa fa-bell" aria-hidden="true"></i>
';
        $buffer .= $indent . '        <!-- ';
        // 'pix' section
...
';
    ...
    public function block31aa3c1866a7493ddfafecc9d79abbe8($context)
    {
        $indent = $buffer = '';
...
';
            $buffer .= $indent . '                <i class="icon fa fa-check" aria-hidden="true"></i>
';
            $buffer .= $indent . '            </a>
';
        }
    ...
    public function block67999e2f21333f5157f00bef03d98aea($context)
    {
        $indent = $buffer = '';
        $blockFunction = $context->findInBlock('anchor');
        if (is_callable($blockFunction)) {
