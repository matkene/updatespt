...
class __Mustache_d6cb3301119d43f4508affb7aace237c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="p-10 rounded bg-white" data-region="confirm-dialogue" role="alert">
';
