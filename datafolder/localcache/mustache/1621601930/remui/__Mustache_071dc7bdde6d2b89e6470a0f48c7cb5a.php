...
class __Mustache_071dc7bdde6d2b89e6470a0f48c7cb5a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="dropdown m-b-1">
';
        $buffer .= $indent . '    <button id="displaydropdown" type="button" class="btn btn-outline-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
';
