...
class __Mustache_afd76dd46a078ae85faf47e0b7c714e1 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</h4>
';
        $buffer .= $indent . '            <div class="list-group m-0" data-region="list"></div>
';
        $buffer .= $indent . '        </div>
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="bg-white">
';
