...
class __Mustache_4f9740050bc3fab1338ad12aa6fd1e3f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section79de92f84fae965de8368935f97410c8($context, $indent, $value);
...
';
    ...
    private function section79de92f84fae965de8368935f97410c8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
<div data-region="settings" class="p-15">
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div data-region="settings" class="p-15">
';
