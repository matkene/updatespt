...
class __Mustache_13c6161cf765b8575ad19ff0dc7651a5 extends Mustache_Template
{
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '    style="overflow-x: hidden; overflow-y: auto;"
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="position-relative h-100" data-region="content-container" style="overflow-y: hidden; overflow-x: hidden">
';
