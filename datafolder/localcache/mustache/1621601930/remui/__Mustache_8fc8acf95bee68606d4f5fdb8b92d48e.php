...
class __Mustache_8fc8acf95bee68606d4f5fdb8b92d48e extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <ul class="list-group unstyled mx-auto w-full">
';
        ...
        $buffer .= $indent . '    </ul>
';
        $buffer .= $indent . '    <div class="bg-pulse-grey m-t-1" style="width: 100px; height: 30px; margin-left: auto; margin-right: auto"></div>
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<ul class="list-group unstyled mx-auto w-full" data-region="courses-list"></ul>
';
