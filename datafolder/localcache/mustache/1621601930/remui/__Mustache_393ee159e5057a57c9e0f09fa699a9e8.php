...
class __Mustache_393ee159e5057a57c9e0f09fa699a9e8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="container p-0 pb-3 border-0">
';
        $buffer .= $indent . '        <div class="row no-gutters flex-nowrap">
';
        $buffer .= $indent . '            <div class="col-sm-6 d-flex justify-content-start">
';
        ...
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="col-sm-6 d-flex justify-content-end">
';
